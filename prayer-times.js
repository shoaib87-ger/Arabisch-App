 ...
 * Fullscreen overlay + Live-Daten + Countdown bis zum nächsten Gebet
 */
...
const PrayerTimes = {
    ...
    /**
     * Open prayer times as fullscreen overlay (same pattern as Quran/Qibla)
     */
    open() {
        const overlay = document.getElementById('prayerOverlay');
        overlay.classList.add('active');
        document.body.style.overflow = 'hidden';
        const container = document.getElementById('prayerScreenContent');
        this.render(container);
    },

    /**
     * Close prayer times overlay
     */
    close() {
        const overlay = document.getElementById('prayerOverlay');
    ...
    /**
     * Render the prayer times content
     */
        ...
        if (!data) {
            container.innerHTML = `
                <div class="prayer-error">
                    ...
                    <button class="btn btn-primary btn-small" onclick="PrayerTimes.render(document.getElementById('prayerScreenContent'))">
                        🔄 Erneut versuchen
                    </button>
                </div>
            `;
